...
module.exports = {
  ...
  startCommit: 'belly is staging and committing all changes...',
  startPush: 'belly is pushing your work to origin...',
  succeedCommit: message => `belly ${chalk.blue('committed')} your work with this message: ${chalk.bgMagenta(message)}`,
  succeedPush: `belly ${chalk.blue('pushed')} your work to origin`,
  switchSuccess: 'belly switched to last branch',
  cliHelp: `
  Usage
    $ belly [c | s | t | r | n | q]

...
module.exports = {
  ...
  startPush: '⬆️  Pushing to origin...',
  succeedCommit: message => ` belly ${chalk.blue('committed your work')} with this message: "${message}"`,
  succeedPush: ' belly pushed your work to origin',
